        ...
        <div className='userShow'>
          ...
          <div className='userShowBottom'>
            ...
            <div className='userShowInfo'>
              ...
              <div className='userShowInfoTitle'>+1 474 844 484</div>
            </div>
            <div className='userShowInfo'>
          ...
          <form className='userUpdateForm'>
            ...
            <div className='userUpdateRight'>
              <div className='userUpdateUpload'>
                <img
                  src='https://in-aps.bmscdn.com/iedb/artist/images/website/poster/large/pankaj-tripathi-29809-23-03-2017-02-54-29.jpg'
                  alt=''
                  className='userUpdateImg'
                />
                <label htmlFor='file'>
                  <Publish class='userUpdateIcon' />
                </label>
